...
Gatling / javaOptions ++= Seq("-XX:+UseG1GC", "-XX:+ParallelRefProcEnabled", "-XX:MaxGCPauseMillis=20", "-Xmx2G", "-Xms2G", "-XX:+AlwaysPreTouch")
GatlingIt / javaOptions ++= Seq("-XX:+UseG1GC", "-XX:+ParallelRefProcEnabled", "-XX:MaxGCPauseMillis=20", "-Xmx2G", "-Xms2G", "-XX:+AlwaysPreTouch")
